...
\033[1;91m☞ Auther     : EYASIN Arafat ✅
\033[1;92m☞ WhatsApp   : 01785504676
\033[1;95m☞ YouTube    : https://www.facebook.com/eyasin.vau.golden.boy
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update EYASIN Tool')
	print (S + '[' + P + '☞3' + S + ']' + S + ' EYASIN WhatsApp Group')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('cd $HOME && git clone https://github.com/eyasinvau')
	    cb()
	    print (logo)
	    psb('☆10%')
	    psb('☆☆20%')
	    ...
	    psb('WhatsApp Num 01785504676✓')
	    psb('WellCome To EYASINHUB')
	    psb('Congratulations EYASINHUB Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ Eyasin✓')
	    psb('🔓Password ☆ Eyasinbd✓')
	    psb('Subscrib My Youtube Chenal EYASIN Arafat ✓')
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd $HOME/Eyasinhubbd && python2 Eyasinhubbd.py')
	elif bm =='3':
	    os.system('xdg-open https://chat.whatsapp.com/FmuKakzK8oV3Rp6gpf9Fqr')
	    menu()
	elif bm =='4':
